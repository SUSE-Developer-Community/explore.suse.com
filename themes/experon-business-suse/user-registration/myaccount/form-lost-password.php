	...
	<form method="post" class="user-registration-ResetPassword lost_reset_password">
		<div class="ur-form-row">
			<div class="ur-form-grid">
				<p>
          <?php echo apply_filters( 'user_registration_lost_password_message', __( 'Lost your password?', 'experon' ) ); ?>
        </p>
        <p>
          <?php echo apply_filters( 'user_registration_lost_password_message', __('Please enter your email address. You will receive a link to create a new password via email.', 'experon' ) ); ?>
        </p>

				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					<label for="user_login">
            <?php _e( 'Email', 'experon' ); ?>
            <span class="required">*</span>
				...
				<p class="user-registration-form-row form-row">
					...
					<input type="submit" class="user-registration-Button button" value="<?php esc_attr_e( 'Reset password', 'experon' ); ?>" />
				</p>
