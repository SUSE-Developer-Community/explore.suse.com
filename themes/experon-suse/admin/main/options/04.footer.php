...
function thinkup_input_footerw1() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'experon') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 1.', 'experon') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'experon' ) . '">' . __( 'Click here to go to Widget area.', 'experon') . '</a>',
			'</div>';
	};
	echo	'</div>';
}
...
function thinkup_input_footerw2() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'experon') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 2.', 'experon') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'experon' ) . '">' . __( 'Click here to go to Widget area.', 'experon') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw3() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'experon') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 3.', 'experon') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'experon' ) . '">' . __( 'Click here to go to Widget area.', 'experon') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw4() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'experon') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 4.', 'experon') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'experon' ) . '">' . __( 'Click here to go to Widget area.', 'experon') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw5() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'experon') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 5.', 'experon') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'experon' ) . '">' . __( 'Click here to go to Widget area.', 'experon') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw6() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'experon') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 6.', 'experon') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'experon' ) . '">' . __( 'Click here to go to Widget area.', 'experon') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_copyright() {
	...
	printf( __( 'Original theme developed by %1$s') , '<a href="//www.thinkupthemes.com/" target="_blank">Think Up Themes Ltd</a>', '<a href="//www.wordpress.org/" target="_blank">WordPress</a>'); 
}
